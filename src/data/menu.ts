    ...
    subs: [
        ...
        groups: [
          {
            ...
            nameZh: "招牌鸡尾酒",
            items: [
              { id: "sg-mr-dameisha", nameEn: "Mr Dameisha", nameZh: "大梅沙先生", descEn: "Italicus liquor, raspberry puree, sparkling wine", descZh: "佛手柑利口酒、树莓果茸、气泡酒", price: 80, accent: "fuchsia-mx" },
              { id: "sg-mrs-xiaomeisha", nameEn: "Mrs Xiaomeisha", nameZh: "小梅沙夫人", descEn: "Strawberry Gin, Campari infused with coffee bean, martini rosso, white cacao liquor, chocolate bitter", descZh: "草莓金酒、金巴利浸泡咖啡豆、马天尼红威末酒、白可可力娇酒、巧克力苦精酒", price: 80, accent: "fuchsia-mx" },
              { id: "sg-mrs-red", nameEn: "Mrs Red", nameZh: "红夫人", descEn: "Olmeca, homemade turmeric syrup, cacao white liquor, lemon juice, fresh turmeric", descZh: "奥美加龙舌兰、自制姜黄根糖浆、白可可力娇酒、柠檬汁、新鲜姜黄根", price: 80, accent: "terracotta" },
              { id: "sg-mr-white", nameEn: "Mr White", nameZh: "白先生", descEn: "Vodka, lemon juice, raspberry puree, cranberry juice, Cointreau", descZh: "伏特加、柠檬汁、树莓果茸、蔓越莓汁、君度", price: 80, accent: "talavera" },
              { id: "sg-mr-black", nameEn: "Mr Black", nameZh: "黑先生", descEn: "Havana 3 yrs rum, espresso coffee, pandan syrup, coconut puree", descZh: "哈瓦那3年朗姆、浓缩咖啡、斑兰糖浆、椰子果茸", price: 80, accent: "terracotta" },
              { id: "sg-mr-yellow", nameEn: "Mr Yellow", nameZh: "黄先生", descEn: "Havana rum 3 yrs, fresh pineapple, caramel syrup, coconut puree, pineapple juice", descZh: "哈瓦那3年朗姆酒、新鲜菠萝、焦糖糖浆、椰子果茸、菠萝汁", price: 80, accent: "saffron" },
              { id: "sg-mr-green", nameEn: "Mr Green", nameZh: "绿先生", descEn: "Beefeater, cardamon seed, pear puree, pandan syrup, kaffir leaves", descZh: "必富达金酒、豆蔻种子、梨子果茸、斑兰糖浆、泰国青柠叶", price: 80, accent: "cactus" },
              { id: "sg-mr-orange", nameEn: "Mr Orange", nameZh: "橙先生", descEn: "Jameson, fresh turmeric, fresh orange, fresh lemon, fresh lime, ginger ale", descZh: "尊美醇威士忌、新鲜姜黄根、新鲜橙子、新鲜柠檬、新鲜青柠、干姜水", price: 80, accent: "saffron" },
            ],
          },
          {
            id: "all-star",
            ...
            nameZh: "明星鸡尾酒",
            items: [
              { id: "as-bkk", nameEn: "BKK Tonic", nameZh: "曼谷汤力", descEn: "Beefeater, passion fruit, kaffir leave, coconut syrup, tonic water", descZh: "必富达金酒、椰子&百香果、泰国青柠&汤力水", price: 80, accent: "cactus" },
              { id: "as-revo", nameEn: "Revolucion Cocktail", nameZh: "革命鸡尾酒", descEn: "Havana 3 yrs, fresh rosemary, passion fruit puree, apple juice, sugar syrup", descZh: "哈瓦那3年朗姆、糖、迷迭香、百香果、苹果", price: 80, accent: "terracotta" },
              { id: "as-cuban", nameEn: "Cuban Gentleman", nameZh: "古巴绅士", descEn: "Havana 7 yrs, vanilla syrup, angostura bitter, fresh orange", descZh: "哈瓦那7年朗姆酒、香草、安格斯苦味酒、橙皮浸泡", price: 90, accent: "saffron" },
              { id: "as-bull-kiss", nameEn: "Bull Kiss", nameZh: "公牛之吻", descEn: "Absolut, vanilla syrup, raspberry puree, cranberry juice, top up with Red Bull foam", descZh: "绝对香草伏特加、树莓、蔓越莓、柠檬&香草红牛泡沫", price: 80, accent: "fuchsia-mx" },
              { id: "as-asian-colada", nameEn: "Asian Colada", nameZh: "亚洲可乐达", descEn: "Havana 3 yrs, passion fruit puree, coconut puree, kaffir lime leaves, coconut syrup", descZh: "哈瓦那3年、百香果果茸、椰子果茸、泰国青柠叶、椰子糖浆", price: 80, accent: "saffron" },
              { id: "as-gg", nameEn: "G&G", nameZh: "西柚金汤力", descEn: "Beefeater, grapefruit syrup, grapefruit juice, tonic water", descZh: "必富达金酒、西柚、汤力水", price: 80, accent: "talavera" },
              { id: "as-passion-jager", nameEn: "Passion of Jager", nameZh: "百香野格", descEn: "Jagermeister, passion fruit puree, fresh lime, sugar syrup", descZh: "野格力口酒、百香果果茸、新鲜青柠、糖浆", price: 80, accent: "cactus" },
              { id: "as-vanilla-passion", nameEn: "Vanilla Passion Martini", nameZh: "香草百香马天尼", descEn: "Absolut, passion fruit puree, strawberry puree, vanilla syrup", descZh: "绝对香草伏特加、香草、草莓、百香果&蛋清", price: 90, accent: "fuchsia-mx" },
            ],
          },
          {
            id: "classic",
            ...
            nameZh: "经典鸡尾酒",
            items: [
              { id: "cl-mai-tai", nameEn: "Mai Tai", nameZh: "迈泰", descEn: "Havana 3 yrs, Havana 7 yrs, fresh lime, orgeat syrup, orange curaçao", descZh: "哈瓦那3年、哈瓦那7年、新鲜青柠、杏仁糖浆、橙皮利口酒", price: 80 },
              { id: "cl-old-fashioned", nameEn: "Old Fashioned", nameZh: "古典鸡尾酒", descEn: "Jim Beam, sugar, fresh orange, angostura bitter", descZh: "占边威士忌、糖、新鲜橙子、安格斯苦精酒", price: 80 },
              { id: "cl-pisco-sour", nameEn: "Pisco Sour", nameZh: "皮斯科酸酒", descEn: "Pisco, lemon juice, sugar syrup, angostura bitter, egg white", descZh: "皮斯克酒、柠檬汁、糖浆、安格斯苦精酒、蛋清", price: 80 },
              { id: "cl-penicillin", nameEn: "Penicillin", nameZh: "盘尼西林", descEn: "Ballantine's whisky, Laphroaig, ginger honey syrup, lemon juice", descZh: "百龄坛威士忌、拉弗格威士忌、生姜蜂蜜糖浆、柠檬汁", price: 80 },
              { id: "cl-negroni", nameEn: "Negroni", nameZh: "尼格罗尼", descEn: "Beefeater, martini rosso, Campari", descZh: "必富达金酒、马天尼红威末酒、金巴利利口酒", price: 80 },
              { id: "cl-paloma", nameEn: "Paloma", nameZh: "帕洛玛", descEn: "Olmeca, grapefruit syrup, grapefruit juice, soda water", descZh: "奥美加龙舌兰、西柚糖浆、西柚汁、苏打水", price: 80 },
              { id: "cl-margarita", nameEn: "Margarita", nameZh: "玛格丽特", descEn: "Olmeca tequila, fresh lime, triple sec", descZh: "奥美加龙舌兰、新鲜青柠、柑橘味利口酒", price: 80 },
              { id: "cl-mojito", nameEn: "Mojito", nameZh: "莫吉托", descEn: "Havana 3 yrs, fresh lime, fresh mint, lime juice, sugar syrup", descZh: "哈瓦那3年、新鲜青柠、新鲜薄荷、青柠汁、糖浆", price: 80 },
              { id: "cl-zombie", nameEn: "Zombie", nameZh: "僵尸", descEn: "Havana 3 yrs, Havana 7 yrs, overproof rum, lemon juice, grapefruit juice, grenadine syrup", descZh: "哈瓦那3年、哈瓦那7年、高浓度朗姆酒、柠檬汁、西柚汁、石榴糖浆", price: 80 },
              { id: "cl-pina-colada", nameEn: "Pina Colada", nameZh: "椰林飘香", descEn: "Havana 3 yrs, fresh pineapple, pineapple juice, coconut puree, coconut syrup", descZh: "哈瓦那3年、新鲜菠萝、菠萝汁、椰子果茸、椰子糖浆", price: 80 },
              { id: "cl-aperol", nameEn: "Aperol Spritz", nameZh: "阿佩罗气泡酒", descEn: "Aperol, sparkling wine, soda water, fresh orange", descZh: "奥佩罗利口酒、气泡酒、苏打水、新鲜橙子", price: 80 },
              { id: "cl-gin-fizz", nameEn: "Gin Fizz", nameZh: "金菲兹", descEn: "Beefeater, lemon juice, sugar syrup, egg white, top soda water", descZh: "必富达金酒、柠檬汁、糖浆、蛋清、苏打水", price: 80 },
              { id: "cl-godfather", nameEn: "God Father", nameZh: "教父", descEn: "Jameson, Disaronno", descZh: "尊美醇威士忌、蒂萨诺力娇酒", price: 80 },
              { id: "cl-caipirinha", nameEn: "Caipirinha", nameZh: "卡琵莉亚", descEn: "Cachaça, fresh lime, sugar", descZh: "卡沙萨酒、新鲜青柠、糖", price: 80 },
              { id: "cl-whisky-sour", nameEn: "Whisky Sour", nameZh: "威士忌酸酒", descEn: "Jameson, lemon juice, sugar syrup, angostura bitter, egg white", descZh: "尊美醇威士忌、柠檬汁、糖浆、安格斯苦精酒、蛋清", price: 80 },
              { id: "cl-moscow-mule", nameEn: "Moscow Mule", nameZh: "莫斯科骡子", descEn: "Absolut Vodka, lime juice, sugar syrup, angostura bitter, ginger beer", descZh: "绝对伏特加、糖、青柠、安格斯苦味酒&姜味啤酒", price: 80 },
              { id: "cl-long-island", nameEn: "Long Island", nameZh: "长岛冰茶", descEn: "Tequila, Vodka, White Rum, Gin, Triple sec, fresh lemon juice, sugar syrup", descZh: "绝对伏特加、必富达金酒、奥美加龙舌兰、橙皮力娇酒、柠檬汁、可乐", price: 90 },
            ],
          },
          {
            id: "mocktail",
            ...
            nameZh: "无酒精鸡尾酒",
            items: [
              { id: "mt-oasis", nameEn: "Oasis Berry", nameZh: "绿洲莓果", descEn: "Apple juice, cassis syrup, raspberry puree", descZh: "苹果汁、黑醋栗糖浆、树莓果茸", price: 60 },
              { id: "mt-apple-mojito", nameEn: "Apple Mojito", nameZh: "苹果莫吉托", descEn: "Mint, lime, sugar, apple juice", descZh: "薄荷、青柠、糖、苹果汁", price: 60 },
              { id: "mt-pink-grapefruit", nameEn: "Pink Grapefruit Fizz", nameZh: "西柚气泡", descEn: "Grapefruit juice, grapefruit syrup, soda water", descZh: "西柚汁、西柚糖浆、苏打水", price: 60 },
              { id: "mt-red-berry", nameEn: "Red Berry", nameZh: "红莓", descEn: "Raspberry, strawberry, cranberry juice, lime and sugar", descZh: "树莓、草莓、蔓越莓汁、青柠、糖", price: 60 },
              { id: "mt-yu-garden", nameEn: "Yu Garden", nameZh: "豫园", descEn: "Apple juice, cardamon seed, pear puree, pandan syrup, kaffir leaves", descZh: "苹果汁、豆蔻种子、梨子果茸、斑兰糖浆、泰国青柠叶", price: 60 },
            ],
          },
          {
            id: "lupita-cocktails",
      ...
      },
      {
        ...
        items: [
          ...
          { id: "sh-woowoo", nameEn: "Woo Woo", nameZh: "蜜桃伏特加", descEn: "Absolut Vodka, Peach liquor, Cranberry juice", descZh: "绝对伏特加、蜜桃酒、蔓越莓汁", price: 40, priceAlt: [{ label: "×1", value: 40 }, { label: "×12", value: 400 }], accent: "fuchsia-mx" },
      ...
      },
      {
        ...
        groups: [
          ...
          },
          {
            ...
            nameZh: "经典系列",
            items: [
              { id: "rv-love66", nameEn: "Love 66", nameZh: "爱66", descEn: "A sweet, refreshing fusion of watermelon and cool mint", descZh: "清甜西瓜与沁凉薄荷的完美融合", price: 218, accent: "fuchsia-mx" },
