...
export function SubTabs({ category, activeSub, onSelect }: Props) {
  return (
    <div className="no-scrollbar flex gap-2 overflow-x-auto px-8 py-4 border-b border-border/40">
      {category.subs.map((sub) => {
        ...
        return (
          <button
            ...
            className={`shrink-0 rounded-full px-5 py-2 text-sm transition-all min-h-[44px] flex items-center gap-2 ${
              active
